  ...
  config = function()
    ...
    require('which-key').add {
      ...
      { '<leader>aicc', '<cmd>ChatGPT<CR>', desc = '💬 ChatGPT' },
      {
        ...
        { '<leader>aice', '<cmd>ChatGPTEditWithInstruction<CR>', desc = '✏️ Edit with instruction' },
        { '<leader>aicf', '<cmd>ChatGPTRun fix_bugs<CR>', desc = '🐛 Fix Bugs' },
        { '<leader>aicg', '<cmd>ChatGPTRun grammar_correction<CR>', desc = '✍️ Grammar Correction' },
        { '<leader>aick', '<cmd>ChatGPTRun keywords<CR>', desc = '🔑 Keywords' },
        { '<leader>aicl', '<cmd>ChatGPTRun code_readability_analysis<CR>', desc = '👁️ Code Readability Analysis' },
